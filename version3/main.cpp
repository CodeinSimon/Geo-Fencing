...
//
//    std::fstream fin("../data/toydata/test_case_2.in", std::fstream::in);
//    std::fstream fout("../data/toydata/test.out", std::fstream::out);
    std::fstream fin("../data/case_3.in", std::fstream::in);
    std::fstream fout("../data/test.out", std::fstream::out);
    time_t time1, time2;
    std::time(&time1);
